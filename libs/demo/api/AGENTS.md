# Demo API — Contributor Notes

## Overview

- **Purpose**: Domain-specific types, interfaces, enums, and pure functions for the Demo domain
- **Ownership**: Consumed by `demo-store`, `demo-ui`, and the Demo app; no Angular dependency

## Test & Lint

- Test: `npx nx run demo-api:test`
- Lint: `npx nx run demo-api:lint`
