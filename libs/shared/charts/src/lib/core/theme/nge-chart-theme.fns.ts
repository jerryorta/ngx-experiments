 ...
 */
export function mergeBaseTheme(userTheme?: Partial<NgeChartBaseTheme>): Required<NgeChartBaseTheme> {
  if (!userTheme) {
    return DEFAULT_CHART_BASE_THEME;
  }

  return {
    axis: { ...DEFAULT_CHART_BASE_THEME.axis, ...filterUndefined(userTheme.axis) },
 ...
 */
export function mergeBarLayerTheme(userTheme?: Partial<NgeBarLayerTheme>): ResolvedNgeBarLayerTheme {
  if (!userTheme) {
  ...
  return {
    ...
    categoryLabel: { ...DEFAULT_BAR_LAYER_THEME.categoryLabel, ...filterUndefined(userTheme.categoryLabel) },
    label: { ...DEFAULT_BAR_LAYER_THEME.label, ...filterUndefined(userTheme.label) },
    statistical: { ...DEFAULT_BAR_LAYER_THEME.statistical, ...filterUndefined(userTheme.statistical) },
 ...
 * Returns a fully resolved theme with all nested properties required.
 */
export function mergeLineLayerTheme(userTheme?: Partial<NgeLineLayerTheme>): ResolvedNgeLineLayerTheme {
  if (!userTheme) {
 ...
 * Returns a fully resolved theme with all nested properties required.
 */
export function mergeBulletLayerTheme(userTheme?: Partial<NgeBulletLayerTheme>): ResolvedNgeBulletLayerTheme {
  if (!userTheme) {
    return DEFAULT_BULLET_LAYER_THEME as ResolvedNgeBulletLayerTheme;
  }

  return {
    backgroundBar: { ...DEFAULT_BULLET_LAYER_THEME.backgroundBar, ...filterUndefined(userTheme.backgroundBar) },
    limitIndicator: { ...DEFAULT_BULLET_LAYER_THEME.limitIndicator, ...filterUndefined(userTheme.limitIndicator) },
    progressBar: { ...DEFAULT_BULLET_LAYER_THEME.progressBar, ...filterUndefined(userTheme.progressBar) },
    progressIndicator: { ...DEFAULT_BULLET_LAYER_THEME.progressIndicator, ...filterUndefined(userTheme.progressIndicator) },
 ...
 * Returns a fully resolved theme with all nested properties required.
 */
export function mergeDivergingBarLayerTheme(userTheme?: Partial<NgeDivergingBarLayerTheme>): ResolvedNgeDivergingBarLayerTheme {
  if (!userTheme) {
    return DEFAULT_DIVERGING_BAR_LAYER_THEME as ResolvedNgeDivergingBarLayerTheme;
  }

  return {
    backgroundBar: { ...DEFAULT_DIVERGING_BAR_LAYER_THEME.backgroundBar, ...filterUndefined(userTheme.backgroundBar) },
    centerIndicator: { ...DEFAULT_DIVERGING_BAR_LAYER_THEME.centerIndicator, ...filterUndefined(userTheme.centerIndicator) },
    limitIndicator: { ...DEFAULT_DIVERGING_BAR_LAYER_THEME.limitIndicator, ...filterUndefined(userTheme.limitIndicator) },
    negativeBar: { ...DEFAULT_DIVERGING_BAR_LAYER_THEME.negativeBar, ...filterUndefined(userTheme.negativeBar) },
    positiveBar: { ...DEFAULT_DIVERGING_BAR_LAYER_THEME.positiveBar, ...filterUndefined(userTheme.positiveBar) },
    valueIndicator: { ...DEFAULT_DIVERGING_BAR_LAYER_THEME.valueIndicator, ...filterUndefined(userTheme.valueIndicator) },
 ...
 * Returns a fully resolved theme with all nested properties required.
 */
export function mergeGroupedBarLayerTheme(userTheme?: Partial<NgeGroupedBarLayerTheme>): ResolvedNgeGroupedBarLayerTheme {
  if (!userTheme) {
...
export function mergeChartTheme(userTheme?: Partial<NgeChartTheme>): NgeChartTheme {
  ...
  return {
    ...
    divergingBar: userTheme.divergingBar ? mergeDivergingBarLayerTheme(userTheme.divergingBar) : DEFAULT_DIVERGING_BAR_LAYER_THEME,
    grid: { ...DEFAULT_CHART_BASE_THEME.grid, ...filterUndefined(userTheme.grid) },
    'grouped-bar': userTheme['grouped-bar'] ? mergeGroupedBarLayerTheme(userTheme['grouped-bar']) : DEFAULT_GROUPED_BAR_LAYER_THEME,
