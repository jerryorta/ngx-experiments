export interface NgeChartTooltipConfig {
  /**
...
export const defaultNgeChartTooltipConfig: NgeChartTooltipConfig = {
  divotHeight: 12,
...
export interface NgeChartTooltipState {
  /** Background color of the tooltip bubble */
  backgroundColor?: string;
  /** Border color of the tooltip bubble */
  borderColor?: string;
...
export const defaultNgeChartTooltipState: NgeChartTooltipState = {
  bubbleHeight: 53,
